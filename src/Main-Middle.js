            ...
            <div className='content-wrapper'>
                <div className='col-one'>
                    <div className='text-container'>
                        <div className='text'>Site has been serving the needs of the photographic community for over a decade. Well known for the superior quality of our prints and our excellent customer service, we have become the lab of choice for professional photographers and savvy consumers all over the country.
                        </div>
                    </div>
